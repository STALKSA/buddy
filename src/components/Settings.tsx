    ...
    <Property1Default className={props.className}>
      ...
      <ListSounds>
        <Item1 onClick={() => handleVoiceTypeChange('male')}>
          <BoxIconSound1 style={{ backgroundColor: voiceType === 'male' ? '#204981' : 'transparent' }}>
            <IconSound1>{`🔊`}</IconSound1>
          </BoxIconSound1>
          <BoxTitleSound1 style={{ textDecorationColor: voiceType === 'male' ? '#7FFFD4' : 'transparent' }}>
        ...
        <Item2 onClick={() => handleVoiceTypeChange('female')}>
          <BoxIconSound2 style={{ backgroundColor: voiceType === 'female' ? '#204981' : 'transparent' }}>
